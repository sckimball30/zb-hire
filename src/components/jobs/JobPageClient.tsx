...
import { Pencil, Users, ChevronDown, ChevronUp, UserPlus, Trash2, ExternalLink, Copy, Check } from 'lucide-react'
...
export function JobPageClient({
  job, groupedApplications, currentTeam, allInterviewers, jobStatusColors, jobStatusLabels,
}: JobPageClientProps) {
