...
export default async function JobLayout({
  ...
  return (
    <div className="flex flex-col h-full">
      {/* Job header */}
      <div className="px-4 md:px-8 pt-4 md:pt-6 pb-0 bg-white border-b border-gray-200 flex-shrink-0">
        ...
        <div className="flex items-center justify-between mb-0">
          <h1 className="text-xl md:text-2xl font-bold text-gray-900 truncate pr-4">{job.title}</h1>
        </div>
