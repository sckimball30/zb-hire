...
export default async function SandboxCaseyMorganPage() {
  ...
  const formatted = interviewDate.toLocaleDateString('en-US', {
    weekday: 'long',
    month: 'long',
    day: 'numeric',
  }) + ' at 2:00 PM'
      ...
      <div className="max-w-3xl mx-auto w-full px-6 py-8 space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-lg text-sm text-blue-800">
            <strong>Notes:</strong> Explore their sales methodology and how they handle objections. Ask for a specific example of closing a difficult deal and their approach to building a pipeline from scratch.
          </div>
        </div>
          ...
          <div className="px-10 py-10 bg-white">
            <div className="max-w-lg mx-auto space-y-5">
              ...
              <div>
                ...
                <div className="h-3 w-68 bg-gray-200 rounded mb-1" />
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="h-3 w-full bg-gray-100 rounded mb-1.5" />
                <div className="h-3 w-4/6 bg-gray-100 rounded mb-1.5" />
                <div className="h-3 w-3/6 bg-gray-100 rounded" />
              </div>
              {/* Education */}
              <div className="border-t border-gray-200 pt-4">
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                <div className="flex gap-2 flex-wrap">
                  {['B2B Sales', 'Salesforce', 'Cold Outreach', 'Negotiation', 'Pipeline Mgmt', 'CRM'].map(s => (
