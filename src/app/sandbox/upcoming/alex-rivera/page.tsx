...
export default async function SandboxAlexRiveraPage() {
      ...
      <div className="max-w-3xl mx-auto w-full px-6 py-8 space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-6">
          ...
          <div className="mt-4 p-3 bg-blue-50 rounded-lg text-sm text-blue-800">
            <strong>Notes:</strong> Focus on their experience with digital marketing campaigns and team leadership. Ask about their biggest campaign launch and how they measured success.
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          ...
          <div className="px-10 py-10 bg-white">
            <div className="max-w-lg mx-auto space-y-5">
              {/* Name + contact */}
              <div>
                <div className="h-7 w-44 bg-gray-800 rounded mb-2" />
                <div className="h-3 w-72 bg-gray-200 rounded mb-1" />
              ...
              <div className="border-t border-gray-200 pt-4">
                ...
                {/* Job 1 */}
                <div className="h-3 w-60 bg-gray-300 rounded mb-1" />
